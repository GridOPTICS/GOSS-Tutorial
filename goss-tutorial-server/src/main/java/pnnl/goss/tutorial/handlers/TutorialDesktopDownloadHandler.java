...
//
//public class TutorialDesktopDownloadHandler extends AbstractRequestHandler {
//
...
//            Connection connection = null; //this.dataservices.getPooledConnection(PROP_TUTORIALDB_DATASERVICE);
